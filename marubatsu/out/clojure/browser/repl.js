...
var seq__1120_1124 = cljs.core.seq.call(null,clojure.browser.repl.print_queue);
var chunk__1121_1125 = null;
var count__1122_1126 = (0);
var i__1123_1127 = (0);
while(true){
if((i__1123_1127 < count__1122_1126)){
var str_1128 = cljs.core._nth.call(null,chunk__1121_1125,i__1123_1127);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),goog.json.serialize(({"repl": clojure.browser.repl._STAR_repl_STAR_, "str": str_1128})));


var G__1129 = seq__1120_1124;
var G__1130 = chunk__1121_1125;
var G__1131 = count__1122_1126;
var G__1132 = (i__1123_1127 + (1));
seq__1120_1124 = G__1129;
chunk__1121_1125 = G__1130;
count__1122_1126 = G__1131;
i__1123_1127 = G__1132;
continue;
} else {
var temp__5720__auto___1133 = cljs.core.seq.call(null,seq__1120_1124);
if(temp__5720__auto___1133){
var seq__1120_1134__$1 = temp__5720__auto___1133;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__1120_1134__$1)){
var c__1992__auto___1135 = cljs.core.chunk_first.call(null,seq__1120_1134__$1);
var G__1136 = cljs.core.chunk_rest.call(null,seq__1120_1134__$1);
var G__1137 = c__1992__auto___1135;
var G__1138 = cljs.core.count.call(null,c__1992__auto___1135);
var G__1139 = (0);
seq__1120_1124 = G__1136;
chunk__1121_1125 = G__1137;
count__1122_1126 = G__1138;
i__1123_1127 = G__1139;
continue;
} else {
var str_1140 = cljs.core.first.call(null,seq__1120_1134__$1);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),goog.json.serialize(({"repl": clojure.browser.repl._STAR_repl_STAR_, "str": str_1140})));


var G__1141 = cljs.core.next.call(null,seq__1120_1134__$1);
var G__1142 = null;
var G__1143 = (0);
var G__1144 = (0);
seq__1120_1124 = G__1141;
chunk__1121_1125 = G__1142;
count__1122_1126 = G__1143;
i__1123_1127 = G__1144;
continue;
}
} else {
}
...
var script__$1 = (function (){var G__1149 = script;
clojure.browser.repl.goog$module$goog$object.set.call(null,G__1149,"type","text/javascript");

clojure.browser.repl.goog$module$goog$object.set.call(null,G__1149,"onload",onload);

clojure.browser.repl.goog$module$goog$object.set.call(null,G__1149,"onreadystatechange",onload);

return G__1149;
})();
if((opt_sourceText == null)){
var G__1150 = script__$1;
clojure.browser.repl.goog$module$goog$object.set.call(null,G__1150,"src",src);

return G__1150;
} else {
var G__1151 = script__$1;
goog.dom.setTextContent(G__1151,opt_sourceText);
...
var path_1152 = goog.debugLoader_.getPathFromDeps_(src);
clojure.browser.repl.goog$module$goog$object.remove.call(null,goog.debugLoader_.written_,path_1152);

clojure.browser.repl.goog$module$goog$object.remove.call(null,goog.debugLoader_.written_,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.basePath),cljs.core.str.cljs$core$IFn$_invoke$arity$1(path_1152)].join(''));
} else {
var path_1153 = clojure.browser.repl.goog$module$goog$object.get.call(null,goog.dependencies_.nameToPath,src);
clojure.browser.repl.goog$module$goog$object.remove.call(null,goog.dependencies_.visited,path_1153);

clojure.browser.repl.goog$module$goog$object.remove.call(null,goog.dependencies_.written,path_1153);

clojure.browser.repl.goog$module$goog$object.remove.call(null,goog.dependencies_.written,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.basePath),cljs.core.str.cljs$core$IFn$_invoke$arity$1(path_1153)].join(''));
}
} else {
}
...
return clojure.browser.net.transmit.call(null,repl_connection,new cljs.core.Keyword(null,"send-result","send-result",35388249),goog.json.serialize(({"repl": repl, "result": (function (){var _STAR_repl_STAR__orig_val__1154 = clojure.browser.repl._STAR_repl_STAR_;
var _STAR_repl_STAR__temp_val__1155 = repl;
(clojure.browser.repl._STAR_repl_STAR_ = _STAR_repl_STAR__temp_val__1155);

try{return clojure.browser.repl.evaluate_javascript.call(null,repl_connection,form);
}finally {(clojure.browser.repl._STAR_repl_STAR_ = _STAR_repl_STAR__orig_val__1154);
}})()})));
}));
